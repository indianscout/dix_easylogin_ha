...
class tx_dixeasylogin_xing_hybrid_auth extends tx_dixeasylogin_hybrid_auth{
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/dix_easylogin/pi1/class.tx_dixeasylogin_xing_hybrid_auth.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/dix_easylogin/pi1/class.tx_dixeasylogin_xing_hybrid_auth.php']);
}
?>